...
const enableToQuestions = {
  ...
  hard: [
    ...
    { ja: "衛星から送られる情報によって、科学者は気候のわずかな変化でさえ長期間にわたって追跡できます。", answer: "The data sent from satellites enables scientists to track even minor climate changes over long periods.", words: ["changes", "climate", "data", "enables", "even", "from", "long periods", "minor", "over", "satellites", "scientists", "sent", "the", "to", "track", "unless"], unused: "unless" },
    { ja: "その新しい教育制度によって、生徒は自分の関心に応じて学習内容を選択できるようになります。", answer: "The new learning system enables students to choose what they study according to their own interests.", words: ["according", "although", "choose", "enables", "interests", "learning", "new", "own", "students", "system", "their", "the", "to", "to", "what they study"], unused: "although" },
...
worksheetDefinitions["enable-to-order"] = {
  ...
  difficulties: {
    ...
    hard: { label: "難関", counts: [5, 10, 12], description: "高校卒業・共通テスト程度。語句を細かく分け、不要語を1語加えます。" }
  }
};
