...
const causeToQuestions = {
  ...
  advanced: [
    ...
    { ja: "その大規模な停電により、病院は一部の手術を延期することになりました。", answer: "The widespread power outage caused the hospital to postpone some operations.", words: ["the hospital", "the widespread power outage", "to postpone some operations", "caused"] },
  ...
  hard: [
    ...
    { ja: "その新たな証拠により、研究者たちは以前の結論を再検討することになりました。", answer: "The new evidence caused researchers to reconsider their previous conclusions.", words: ["caused", "conclusions", "evidence", "new", "previous", "researchers", "reconsider", "the", "their", "to", "although"], unused: "although" },
    ...
    { ja: "その制度上の不備により、本来支援を受けられるはずの人々まで、申請をやり直すことになりました。", answer: "The flaws in the system caused even people who were eligible for assistance to resubmit their applications.", words: ["applications", "assistance", "caused", "eligible", "even", "flaws", "for", "in", "people", "resubmit", "system", "the", "the", "their", "to", "were", "who", "although"], unused: "although" },
