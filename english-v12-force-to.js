...
const forceToQuestions = {
  ...
  hard: [
    ...
    { ja: "十分な安全対策が取られていなかったため、作業員たちは予定より早く作業を中止せざるを得ませんでした。", answer: "The lack of sufficient safety measures forced the workers to stop work earlier than planned.", words: ["earlier", "forced", "lack", "measures", "of", "safety", "stop", "sufficient", "the", "the", "to", "work", "workers", "than planned", "although"], unused: "although" },
    { ja: "その新しい証拠により、研究者たちはこれまで広く受け入れられていた説明を根本から見直さざるを得ませんでした。", answer: "The new evidence forced the researchers to fundamentally reconsider the previously widely accepted explanation.", words: ["accepted", "explanation", "forced", "fundamentally", "previously", "reconsider", "researchers", "the", "the", "to", "widely", "evidence", "new", "although"], unused: "although" },
    ...
    { ja: "その制度上の不備により、本来支援を受けられるはずの人々まで申請をやり直さざるを得なくなりました。", answer: "The flaws in the system forced even people who were eligible for assistance to resubmit their applications.", words: ["applications", "assistance", "eligible", "even", "flaws", "for", "forced", "in", "people", "resubmit", "system", "the", "their", "to", "were", "who", "although"], unused: "although" },
    ...
    { ja: "その交渉の決裂により、両国は当初は検討していなかった代替案まで検討せざるを得ませんでした。", answer: "The breakdown of the negotiations forced both countries to consider even alternative options they had not originally considered.", words: ["alternative", "both", "breakdown", "consider", "considered", "countries", "even", "forced", "had", "negotiations", "not", "of", "options", "originally", "the", "the", "they", "to", "unless"], unused: "unless" },
