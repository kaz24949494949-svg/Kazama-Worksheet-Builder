...
const forceToQuestions = {
  ...
  hard: [
    ...
    { ja: "その新しい証拠により、研究者たちは、それまで広く受け入れられていた説明を根本から見直さざるを得ませんでした。", answer: "The new evidence forced the researchers to fundamentally reconsider the explanation that had previously been widely accepted.", words: ["accepted", "been", "evidence", "explanation", "forced", "fundamentally", "had", "new", "previously", "reconsider", "researchers", "that", "the", "the", "to", "widely", "although"], unused: "although" },
