...
const remindOfQuestions = {
  ...
  standard: [
    ...
    { ja: "この料理の味を感じると、私たちは子どものころに家族で食べた夕食を思い出します。", answer: "The taste of this dish reminds us of the dinners we had with our family when we were children.", words: ["us", "the taste of this dish", "of the dinners we had with our family when we were children", "reminds"] },
    ...
    { ja: "その町の雰囲気に、彼は若いころ住んでいた町を思い出しました。", answer: "The atmosphere of the town reminded him of the town where he lived when he was young.", words: ["him", "the atmosphere of the town", "of the town where he lived when he was young", "reminded"] },
  ...
  advanced: [
    ...
    { ja: "その古い駅を見ると、彼女は若いころ毎朝そこから通勤していた日々を思い出しました。", answer: "The old station reminded her of the days when she used to commute from there every morning.", words: ["her", "the old station", "of the days when she used to commute from there every morning", "reminded"] },
  ...
  hard: [
    { ja: "この古い写真を見ると、私は家族と初めて海外旅行をしたころを思い出します。", answer: "This photograph reminds me of when I first traveled abroad with my family.", words: ["abroad", "family", "first", "I", "me", "my", "of", "photograph", "reminds", "the", "this", "traveled", "when", "with", "although"], unused: "although" },
    ...
    { ja: "この古い手紙を見ると、私は長い間連絡を取っていない友人と過ごした学生時代を思い出します。", answer: "This letter reminds me of the school days I spent with a friend whom I have not been in touch with for years.", words: ["a", "been", "days", "for", "friend", "have", "I", "I", "in", "letter", "me", "not", "of", "reminds", "school", "spent", "the", "this", "touch", "with", "with", "years", "whom", "although"], unused: "although" },
    ...
    { ja: "その古い駅を見ると、彼女は若いころ毎朝そこから通勤していた日々を思い出しました。", answer: "The old station reminded her of the days when she used to commute from there every morning.", words: ["commute", "days", "every", "from", "her", "morning", "of", "old", "reminded", "she", "station", "the", "the", "there", "to", "used", "when", "whereas"], unused: "whereas" },
