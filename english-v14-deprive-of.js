...
const depriveOfQuestions = {
  ...
  advanced: [
    ...
    { ja: "深刻な人手不足によって、患者は適時に医療を受ける機会を失いました。", answer: "Severe staff shortages deprived patients of timely medical attention.", words: ["attention", "deprived", "medical", "of", "patients", "severe", "shortages", "staff", "timely"] },
  ...
  hard: [
    ...
    { ja: "そのプラットフォームの突然の停止によって、小規模な販売者は頼りにしていた収入を失いました。", answer: "The sudden collapse of the platform deprived small sellers of the income they had come to depend on.", words: ["although", "collapse", "come", "depend", "deprived", "had", "income", "of", "of", "on", "platform", "sellers", "small", "sudden", "the", "the", "the", "they", "to"], unused: "although" },
    { ja: "根強い誤情報によって、有権者は十分な判断をするために必要な信頼できる情報を得られなくなりました。", answer: "Persistent misinformation deprived voters of the reliable information needed to make informed choices.", words: ["choices", "deprived", "information", "informed", "make", "misinformation", "needed", "of", "persistent", "reliable", "the", "to", "voters", "whereas"], unused: "whereas" },
