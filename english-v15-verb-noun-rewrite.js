...
const verbNounRewriteQuestions = {
  basic: [
    ...
    { source: "There was a clear improvement in his condition.", prompt: "His condition（　　　）（　　　）.", blanks: "improved / clearly", answer: "His condition improved clearly." },
  ...
  standard: [
    { source: "The company expanded rapidly into Asian markets.", prompt: "There was（　　　）（　　　）the company into Asian markets.", blanks: "rapid expansion / of", answer: "There was rapid expansion of the company into Asian markets." },
    ...
    { source: "The researchers developed a new treatment.", prompt: "The researchers made（　　　）（　　　）a new treatment.", blanks: "the development / of", answer: "The researchers made the development of a new treatment." },
    ...
    { source: "The scientist made an important discovery about the disease.", prompt: "The scientist（　　　）（　　　）about the disease.", blanks: "discovered / something important", answer: "The scientist discovered something important about the disease." }
  ],
  advanced: [
    ...
    { source: "The discovery of the new evidence changed the direction of the investigation completely.", prompt: "The new evidence was discovered, and this brought about（　　　）（　　　）the direction of the investigation.", blanks: "a complete change / in", answer: "The new evidence was discovered, and this brought about a complete change in the direction of the investigation." }
  ],
  hard: [
    ...
    { source: "Public confidence in the institution declined sharply after the investigation revealed serious misconduct.", prompt: "The investigation's revelation of serious misconduct led to（　　　）（　　　）public confidence in the institution.", blanks: "a sharp decline / in", answer: "The investigation's revelation of serious misconduct led to a sharp decline in public confidence in the institution." },
    ...
    { source: "There was a marked improvement in how accurately the system could identify rare errors.", prompt: "The system's ability to identify rare errors（　　　）（　　　）.", blanks: "improved / markedly", answer: "The system's ability to identify rare errors improved markedly." },
    ...
    { source: "The unexpected discovery of additional documents completely changed the investigators' understanding of the case.", prompt: "The investigators unexpectedly discovered additional documents, which（　　　）（　　　）their understanding of the case.", blanks: "completely changed / —", answer: "The investigators unexpectedly discovered additional documents, which completely changed their understanding of the case." }
  ]
};
...
worksheetDefinitions["verb-noun-rewrite"] = {
  ...
  difficulties: {
    ...
    standard: { label: "標準", counts: [5, 10, 12], description: "reduce・recover・decline・attempt・agreement・discoveryなどを加え、前置詞や修飾語も書き換えます。" },
