...
const verbNounRewriteQuestions = {
  basic: [
    ...
    { source: "The town grew rapidly.", prompt: "The town experienced（　　　）.", blanks: "rapid growth", answer: "The town experienced rapid growth." },
  ...
  standard: [
    ...
    { source: "The city reduced waste significantly last year.", prompt: "The city achieved（　　　）（　　　）waste last year.", blanks: "a significant reduction / in", answer: "The city achieved a significant reduction in waste last year." },
  ...
  advanced: [
    ...
    { source: "The government decided to introduce stricter safety standards.", prompt: "The government（　　　）（　　　）introduce stricter safety standards.", blanks: "made a decision / to", answer: "The government made a decision to introduce stricter safety standards." },
    ...
    { source: "The factory substantially reduced the amount of plastic it used.", prompt: "The factory achieved（　　　）（　　　）the amount of plastic it used.", blanks: "a substantial reduction / in", answer: "The factory achieved a substantial reduction in the amount of plastic it used." },
  ...
  hard: [
    ...
    { source: "Public confidence in the institution declined sharply after the investigation revealed serious misconduct.", prompt: "The revelation of serious misconduct during the investigation was followed by（　　　）（　　　）public confidence in the institution.", blanks: "a sharp decline / in", answer: "The revelation of serious misconduct during the investigation was followed by a sharp decline in public confidence in the institution." },
    ...
    { source: "The committee's detailed examination of the evidence revealed several inconsistencies in the original report.", prompt: "By（　　　）, the committee revealed several inconsistencies in the original report.", blanks: "examining the evidence in detail", answer: "By examining the evidence in detail, the committee revealed several inconsistencies in the original report." },
