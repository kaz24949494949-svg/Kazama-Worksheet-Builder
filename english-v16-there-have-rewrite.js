...
const thereHaveRewriteQuestions = {
  basic: [
    ...
    { source: "There is a large kitchen in the house.", prompt: "The house（　　　）（　　　）large kitchen.", blanks: "has / a", answer: "The house has a large kitchen." },
    ...
    { source: "There is a reading room in the library.", prompt: "The library（　　　）（　　　）reading room.", blanks: "has / a", answer: "The library has a reading room." },
  ...
  standard: [
    ...
    { source: "The apartment has two bedrooms and a small study.", prompt: "There（　　　）（　　　）bedrooms and a small study in the apartment.", blanks: "are / two", answer: "There are two bedrooms and a small study in the apartment." },
  ...
  advanced: [
    ...
    { source: "There is a separate entrance for delivery vehicles at the back of the building.", prompt: "The building（　　　）（　　　）separate entrance for delivery vehicles at the back.", blanks: "has / a", answer: "The building has a separate entrance for delivery vehicles at the back." },
