...
const emotionVerbRewriteQuestions = {
  ...
  hard: [
    ...
    { source: "The residents have been increasingly concerned about the decline in local medical services.", prompt: "The decline in local medical services（　　　）（　　　）the residents.", blanks: "has increasingly / concerned", answer: "The decline in local medical services has increasingly concerned the residents." },
    ...
    { source: "The board was disappointed that the revised plan failed to address the central problem.", prompt: "That the revised plan failed to address the central problem（　　　）（　　　）.", blanks: "disappointed / the board", answer: "That the revised plan failed to address the central problem disappointed the board." }
  ]
};
