...
const emotionVerbRewriteQuestions = {
  ...
  hard: [
    ...
    { source: "The unexpected drop in donations deeply concerned the organizers.", prompt: "The organizers（　　　）（　　　）the unexpected drop in donations.", blanks: "were deeply concerned / about", answer: "The organizers were deeply concerned about the unexpected drop in donations." },
    { source: "The committee was not satisfied with the explanation given for the sudden change in policy.", prompt: "The explanation given for the sudden change in policy（　　　）（　　　）the committee.", blanks: "did not / satisfy", answer: "The explanation given for the sudden change in policy did not satisfy the committee." },
    ...
    { source: "The public had been confused by the conflicting information released by different agencies.", prompt: "The conflicting information released by different agencies（　　　）（　　　）the public.", blanks: "had / confused", answer: "The conflicting information released by different agencies had confused the public." },
    { source: "The revised plan disappointed the board because it failed to address the central problem.", prompt: "The board（　　　）（　　　）the revised plan because it failed to address the central problem.", blanks: "was disappointed / with", answer: "The board was disappointed with the revised plan because it failed to address the central problem." }
  ]
};
