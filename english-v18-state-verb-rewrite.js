...
const stateVerbRewriteQuestions = {
  ...
  advanced: [
    ...
    { source: "The report is concerned mainly with how the policy affected smaller communities.", prompt: "The report（　　　）（　　　）how the policy affected smaller communities.", blanks: "concerns / mainly", answer: "The report concerns mainly how the policy affected smaller communities." },
