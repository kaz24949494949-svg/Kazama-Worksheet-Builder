...
const stateVerbRewriteQuestions = {
  ...
  advanced: [
    ...
    { source: "The report is concerned mainly with the effects of the policy on smaller communities.", prompt: "The report（　　　）（　　　）the effects of the policy on smaller communities.", blanks: "mainly / concerns", answer: "The report mainly concerns the effects of the policy on smaller communities." },
  ...
  hard: [
    { source: "Although the revised framework is similar to the original one in overall structure, it differs in several important details.", prompt: "Although the revised framework（　　　）（　　　）original one in overall structure, it differs in several important details.", blanks: "resembles / the", answer: "Although the revised framework resembles the original one in overall structure, it differs in several important details." },
