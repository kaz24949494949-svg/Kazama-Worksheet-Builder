...
const activePassiveRewriteQuestions = {
  ...
  advanced: [
    ...
    { source: "The results have not been independently confirmed by another laboratory.", prompt: "Another laboratory（　　　）（　　　）the results independently.", blanks: "has not / confirmed", answer: "Another laboratory has not confirmed the results independently." },
