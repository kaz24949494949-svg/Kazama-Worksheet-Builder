...
const activePassiveRewriteQuestions = {
  ...
  standard: [
    ...
    { source: "The entrance must be kept clear by all visitors.", prompt: "All visitors（　　　）（　　　）entrance clear.", blanks: "must keep / the", answer: "All visitors must keep the entrance clear." },
  ...
  advanced: [
    { source: "The research team has carefully analyzed the data collected during the survey.", prompt: "The data collected during the survey（　　　）（　　　）the research team.", blanks: "has been carefully analyzed / by", answer: "The data collected during the survey has been carefully analyzed by the research team." },
    ...
    { source: "The results have not been independently confirmed by another laboratory.", prompt: "Another laboratory（　　　）（　　　）the results independently.", blanks: "has not confirmed / the results", answer: "Another laboratory has not confirmed the results independently." },
    ...
    { source: "The new guidelines should have been reviewed by the legal department before publication.", prompt: "The legal department（　　　）（　　　）the new guidelines before publication.", blanks: "should have reviewed / the new guidelines", answer: "The legal department should have reviewed the new guidelines before publication." }
  ],
  hard: [
    ...
    { source: "The agency should have informed local residents about the change before the work began.", prompt: "Local residents（　　　）（　　　）the agency about the change before the work began.", blanks: "should have been informed / by", answer: "Local residents should have been informed by the agency about the change before the work began." },
    ...
    { source: "All measurements recorded during the first stage were checked independently by two technicians.", prompt: "Two technicians（　　　）（　　　）all measurements recorded during the first stage.", blanks: "independently checked / all", answer: "Two technicians independently checked all measurements recorded during the first stage." },
    ...
    { source: "The long-term effects of the policy are being studied by researchers at three universities.", prompt: "Researchers at three universities（　　　）（　　　）the long-term effects of the policy.", blanks: "are studying / the long-term effects of the policy", answer: "Researchers at three universities are studying the long-term effects of the policy." },
    ...
    { source: "The evidence presented at the hearing must be evaluated carefully by the committee before any conclusion is reached.", prompt: "The committee（　　　）（　　　）the evidence presented at the hearing before any conclusion is reached.", blanks: "must carefully evaluate / the evidence presented at the hearing", answer: "The committee must carefully evaluate the evidence presented at the hearing before any conclusion is reached." }
  ]
};
