...
const superlativeComparativeRewriteQuestions = {
  basic: [
    ...
    { source: "Aya runs the fastest on the team.", prompt: "Aya runs（　　　）（　　　）runner on the team.", blanks: "faster than / any other", answer: "Aya runs faster than any other runner on the team." },
  ...
  standard: [
    { source: "Emma sings best in the school choir.", prompt: "Emma sings（　　　）（　　　）singer in the school choir.", blanks: "better than / any other", answer: "Emma sings better than any other singer in the school choir." },
  ...
  advanced: [
    ...
    { source: "The final experiment produced the most reliable results of all the experiments in the study.", prompt: "The final experiment produced（　　　）（　　　）experiment in the study did.", blanks: "more reliable results than / any other", answer: "The final experiment produced more reliable results than any other experiment in the study did." },
    ...
    { source: "The eastern route is the longest route currently open to traffic.", prompt: "The eastern route is（　　　）（　　　）route currently open to traffic.", blanks: "longer than / any other", answer: "The eastern route is longer than any other route currently open to traffic." }
  ],
  hard: [
    ...
    { source: "This manuscript is older than any other document preserved in the archive.", prompt: "This manuscript is（　　　）（　　　）preserved in the archive.", blanks: "the oldest / document", answer: "This manuscript is the oldest document preserved in the archive." },
    ...
    { source: "Her score was the highest recorded in the current group.", prompt: "Her score was（　　　）（　　　）score recorded in the current group.", blanks: "higher than / any other", answer: "Her score was higher than any other score recorded in the current group." },
    ...
    { source: "The new material is the strongest material the company has ever used.", prompt: "The new material is（　　　）（　　　）material the company has ever used.", blanks: "stronger than / any other", answer: "The new material is stronger than any other material the company has ever used." }
  ]
};
...
worksheetDefinitions["superlative-comparative-rewrite"] = {
  label: "書き換え⑥ 最上級 ⇄ 比較級",
  title: "書き換え⑥　最上級 ⇄ 比較級",
  instruction: "次の2文がほぼ同じ意味になるように、空欄に適する語句を書きなさい。比較する範囲、最上級と比較級の形、any other＋単数名詞の使い方に注意しなさい。",
  answerNote: "最上級⇄比較級では、主語が同じ比較集団に含まれるとき、the＋最上級 ⇄ 比較級＋than any other＋単数名詞を基本にします。比較する範囲と修飾語を変えないようにします。",
  ...
  difficulties: {
    ...
    advanced: { label: "発展", counts: [5, 10, 12], description: "長い修飾語、数量表現、least・fewest、限定された比較範囲を含む文で意味を保って書き換えます。" },
