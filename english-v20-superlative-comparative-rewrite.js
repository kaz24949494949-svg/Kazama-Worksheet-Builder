...
const superlativeComparativeRewriteQuestions = {
  ...
  advanced: [
    ...
    { source: "This year's attendance was higher than that of any other year in the past decade.", prompt: "This year's attendance（　　　）（　　　）in the past decade.", blanks: "was the highest / recorded", answer: "This year's attendance was the highest recorded in the past decade." },
  ...
  hard: [
    ...
    { source: "Her score was higher than any score recorded by the previous group.", prompt: "Her score was（　　　）（　　　）recorded by the previous group.", blanks: "higher than / the highest score", answer: "Her score was higher than the highest score recorded by the previous group." },
