...
const superlativePositiveRewriteQuestions = {
  ...
  advanced: [
    ...
    { source: "The appendix contains the most detailed data of all the sections in the report.", prompt: "No other section in the report contains data（　　　）（　　　）those in the appendix.", blanks: "as detailed / as", answer: "No other section in the report contains data as detailed as those in the appendix." },
  ...
  hard: [
    ...
    { source: "This region experienced the most severe decline in population of all the regions included in the survey.", prompt: "No other region included in the survey experienced a decline in population（　　　）（　　　）this region did.", blanks: "as severe as / the one", answer: "No other region included in the survey experienced a decline in population as severe as the one this region did." },
    ...
    { source: "The latest survey recorded the highest response rate of all the surveys conducted by the organization in the past five years.", prompt: "No other survey conducted by the organization in the past five years recorded（　　　）（　　　）the latest survey.", blanks: "as high a response rate / as", answer: "No other survey conducted by the organization in the past five years recorded as high a response rate as the latest survey." },
