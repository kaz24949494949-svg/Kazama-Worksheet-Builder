...
const comprehensiveRewriteQuestions = {
  ...
  advanced: [
    { source: "The researchers made a careful analysis of the survey results.", prompt: "The researchers（　　　）（　　　）the survey results.", blanks: "carefully / analyzed", answer: "The researchers carefully analyzed the survey results." },
    ...
    { source: "The discovery of the error completely changed the direction of the investigation.", prompt: "The discovery of the error brought about（　　　）（　　　）the direction of the investigation.", blanks: "a complete change / in", answer: "The discovery of the error brought about a complete change in the direction of the investigation." },
  ...
  hard: [
    { source: "The investigators' discovery of the new evidence brought about a complete change in the direction of the investigation.", prompt: "The investigators（　　　）（　　　）, and this brought about a complete change in the direction of the investigation.", blanks: "discovered / the new evidence", answer: "The investigators discovered the new evidence, and this brought about a complete change in the direction of the investigation." },
    ...
    { source: "The results have not yet been independently confirmed by the external laboratory.", prompt: "The external laboratory（　　　）（　　　）the results independently.", blanks: "has not yet / confirmed", answer: "The external laboratory has not yet confirmed the results independently." },
