...
const keepFromIngQuestions = {
  ...
  hard: [
    ...
    { ja: "周囲からの激しい批判でさえ、彼女が自分の判断に従って行動するのを止めることはできませんでした。", answer: "Even the severe criticism from those around her could not keep her from acting according to her own judgment.", words: ["according", "acting", "around", "could", "criticism", "even", "from", "from", "her", "her", "her", "judgment", "keep", "not", "own", "severe", "the", "those", "to", "because"], unused: "because" },
